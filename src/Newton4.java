 ...
 * iteration, given a user's desired epsilon value, and number. This one exits
 * when user enters a negative value rather than 'n'.
 *
 * @author Omar Takruri
 *
 */
public final class Newton4 {
    ...
    public static void main(String[] args) {
        ...
        out.print("Enter a positive number (or a negative number to quit): ");
